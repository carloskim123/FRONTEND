  ...
  return (
    <MotionWrapper>
      ...
      <div className="flex flex-col min-h-screen mb-[100px]">
        ...
        <img
          className="w-full md:w-[250px] lg:w-[200px] h-[130px] md:h-40 lg:h-50 rounded-md"
            ...
            <section>
                ...
                <div className="mt-6">
                  ...
                  >
                   ...
                   <button
                    className="underline text-red-500 px-4 text-sm m:text-sm md:text-sm lg:text-lg  py-2 rounded-lg"
